...
ENERGY_COST_PER_KWH = float(
    os.getenv("ENERGY_COST_PER_KWH", "0.13")
)
    ...
    for attempt in range(max_retries):
        ...
        try:
            ...
            input_regs = {
                ...
                "voltage_thd_l1": (11296, False, 100),
                "voltage_thd_l2": (11344, False, 100),
                "voltage_thd_l3": (11392, False, 100),

                "current_thd_l1": (11440, False, 100),
                "current_thd_l2": (11456, False, 100),
                "current_thd_l3": (11536, False, 100),
            }
            ...
            pf_improvement = data["pf_improvement"]

            if pf_improvement > 0 and P > 0:

                data["pf_cost_avoided_monthly"] = round(
                    (
                        Q_cap_total
                        / (abs(Q_measured) + 1e-6)
                    )
                ...
                data["pf_annualized_savings"] = round(
                    data["pf_cost_avoided_monthly"] * 12,
                    2
                )

            else:

                data["pf_cost_avoided_monthly"] = 0.0
                data["pf_annualized_savings"] = 0.0
